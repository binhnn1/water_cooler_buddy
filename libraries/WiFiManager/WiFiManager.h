...
const char HTTP_PORTAL_OPTIONS[] PROGMEM = "<form action=\"/0MQTT\" method=\"post\"><button>MQTT SERVER SETTING</button></form><br/><form action=\"/wifi\" method=\"post\"><button>Configure WiFi</button></form><br/><form action=\"/0wifi\" method=\"post\"><button>Configure WiFi (No Scan)</button></form><br/><form action=\"/i\" method=\"post\"><button>Info</button></form><br/><form action=\"/r\" method=\"post\"><button>Reset</button></form>";
...
const char HTTP_FORM_MQTT[] PROGMEM = "<form method='get' action='MQTTsave'><input id='s' name='s' length=32 placeholder='MQTT SERVER'><br/><input id='po' name='po' length=64 placeholder='MQTT PORT'><br/><input id='u' name='u' length=32 placeholder='MQTT USER'><br/><input id='p' name='p' length=64 type='password' placeholder='MQTT PASSWORD'><br/>";
